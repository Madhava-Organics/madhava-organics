  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={`Stay updated with the latest news, healthy tips, and organic living insights from ${COMPANY_NAME}.`} />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Discover healthy living tips, organic recipes, and benefits of pure farm-to-table products from {COMPANY_NAME}.
            </p>
          </motion.div>
              ...
              blogs.map((blog, index) => (
                ...
                >
                  <Link to={`/blog/${blog.id}`} className="block relative overflow-hidden h-56">
                    ...
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold text-primary flex items-center">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="pt-4 border-t border-gray-100 mt-auto">
                      <Link to={`/blog/${blog.id}`} className="inline-flex items-center text-primary font-semibold hover:text-primary-dark hover:underline group/link">
