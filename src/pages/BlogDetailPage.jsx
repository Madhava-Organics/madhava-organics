...
const BlogDetailPage = () => {
  ...
  if (!blog) {
    return (
      <>
        <Helmet>
          <title>Blog Not Found | {COMPANY_NAME}</title>
        </Helmet>
        <Navbar />
  ...
  return (
    <>
      <Helmet>
        <title>{blog.title} | {COMPANY_NAME}</title>
        ...
        <div className="container mx-auto px-4 py-16">
           <div className="max-w-3xl mx-auto">
             <motion.div 
               ...
               className="prose prose-lg prose-headings:text-gray-900 prose-p:text-gray-600 prose-a:text-primary prose-img:rounded-xl max-w-none"
             >
                <div className="text-xl font-medium text-gray-800 mb-10 leading-relaxed border-l-4 border-primary pl-6 italic">
                   {blog.excerpt}
                </div>
