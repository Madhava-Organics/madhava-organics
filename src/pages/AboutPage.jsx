...
const AboutPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{content.about?.title} | {COMPANY_NAME}</title>
        <meta name="description" content={`Learn about ${COMPANY_NAME}'s mission to provide pure, synthetic-free organic products. Family-run, health-focused, and quality-driven.`} />
      </Helmet>
