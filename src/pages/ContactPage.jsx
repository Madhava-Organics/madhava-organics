...
const ContactPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{content.contact?.title} | {COMPANY_NAME}</title>
        <meta name="description" content={`Contact ${COMPANY_NAME} for samples and orders. Call us or visit directly.`} />
      </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${content.global?.contactPhone}`} className="text-primary font-semibold hover:underline">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${content.global?.contactEmail}`} className="text-primary font-semibold hover:underline break-all">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" className="w-full bg-primary hover:bg-primary-dark text-white py-6 text-lg">
                  Send Message
                </Button>
              </form>
            </motion.div>
