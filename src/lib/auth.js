...
const AUTH_SESSION_KEY = AUTH_CONFIG.sessionKey;
const AUTH_CREDS_KEY = AUTH_CONFIG.credsKey;

// Default Credentials
export const DEFAULT_USER = AUTH_CONFIG.defaultUser;
const DEFAULT_PASS_PLAIN = AUTH_CONFIG.defaultPassword; 

export const SESSION_DURATION = AUTH_CONFIG.sessionDuration;
export const WARNING_THRESHOLD = AUTH_CONFIG.warningThreshold;
