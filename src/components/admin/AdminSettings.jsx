...
const AdminSettings = () => {
    ...
    const handleFullBackup = () => {
        ...
        const data = {
            products: JSON.parse(localStorage.getItem(STORAGE_KEYS.productsBackup) || '[]'),
            siteContent: JSON.parse(localStorage.getItem(STORAGE_KEYS.contentBackup) || '{}'),
            pageImages: JSON.parse(localStorage.getItem(STORAGE_KEYS.imagesBackup) || '{}'),
            blogs: JSON.parse(localStorage.getItem(STORAGE_KEYS.blogsBackup) || '[]'),
    ...
    const handleFullRestore = (e) => {
        ...
        reader.onload = (event) => {
            try {
                ...
                if (backup.products) localStorage.setItem(STORAGE_KEYS.productsBackup, JSON.stringify(backup.products));
                if (backup.siteContent) localStorage.setItem(STORAGE_KEYS.contentBackup, JSON.stringify(backup.siteContent));
                if (backup.pageImages) localStorage.setItem(STORAGE_KEYS.imagesBackup, JSON.stringify(backup.pageImages));
                if (backup.blogs) localStorage.setItem(STORAGE_KEYS.blogsBackup, JSON.stringify(backup.blogs));
