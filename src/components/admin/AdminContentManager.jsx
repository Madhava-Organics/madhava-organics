  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden animate-in fade-in duration-500">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="border-b border-gray-200 bg-gray-50 px-6 pt-4 pb-4">
            ...
            <TabsList className="bg-white p-1 border border-gray-200 rounded-xl shadow-sm h-auto inline-flex">
              ...
              {pages.map(page => (
                <TabsTrigger 
                  key={page} 
                  value={page}
                  className="px-6 py-3 rounded-xl data-[state=active]:bg-primary data-[state=active]:text-white transition-all flex items-center gap-2 capitalize"
                >
                  {page === 'home' && <Home className="w-4 h-4" />}
                  {page}
                </TabsTrigger>
              ))}
            </TabsList>
              ...
              <Tabs value={subTab} onValueChange={setSubTab} className="w-full">
                ...
                <TabsContent value="structure" className="space-y-6">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <Button onClick={() => handleAddSection(pageName)} className="bg-primary hover:bg-primary-dark text-white">
